...
// define(['plugins/http', 'durandal/app', 'knockout','durandal/system','plugins/router','./calendarmr','./reservemr','plugins/dialog'], function (http, app, ko,system,router,calendarmr,reservemr,dialog) {
